...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="form-container">
            ...
            <form method="POST">
                <div class="row mb-3">
                    <div class="col-6"><label class="fw-bold">Nota Empresa</label><input type="number" name="n1" step="0.1" class="form-control" required></div>
                    <div class="col-6"><label class="fw-bold">Nota Escola</label><input type="number" name="n2" step="0.1" class="form-control" required></div>
                </div>
                <div class="row mb-4">
                    <div class="col-6"><label class="fw-bold">Nota Procura</label><input type="number" name="n3" step="0.1" class="form-control" required></div>
                    <div class="col-6"><label class="fw-bold">Nota Relatório</label><input type="number" name="n4" step="0.1" class="form-control" required></div>
                </div>
